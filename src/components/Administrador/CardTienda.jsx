...
function CardTienda(props) {
  return (
    <>
      <section class=" mr-auto ml-auto mt-6  w-80 transform overflow-hidden rounded-[5px] bg-black  shadow-md duration-100 hover:scale-105 hover:shadow-lg text-center">
