        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex flex-row">
            <div className="w-3/6 ml-40 mt-10">
              <label className="mb-3 block text-base text-left font-ralewayFont font-semibold my-2">
                Nombre
              </label>
              <input
                id="nombre"
              ...
              <select
                ...
                onChange={handleInputChange}
                className="w-full rounded-md border  bg-white py-3 px-6 text-base font-medium font-ralewayFont text-black outline-none  focus:shadow-md  border-[#004643] focus:border-[#004643] focus:ring-2 focus:ring-[#004643] my-1"
              >
                ...
                {tallasCategoria[formValues.categoria].map((talla, index) => (
                  <div key={talla} className="w-1/4 p-1">
                    <input
                      ...
                      className="w-4 h-4 text-[#D1AC00] bg-gray-100 border-gray-300 rounded focus:ring-[#004643] dark:focus:ring-[#004643] dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                    />
                    <label htmlFor={talla} className="font-ralewayFont font-semibold p-2">{talla}</label>
            ...
            <div className="ml-60 py-60 w-auto h-auto rounded-r-md ">
              <span
                className="rounded-md border bg-[#004643] py-3 px-10 text-base font-medium text-white outline-none focus:border-[#004643] focus:ring-2 focus:ring-[#004643]  hover:bg-black"
